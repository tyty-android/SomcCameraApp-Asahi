...
.method constructor <init>(Landroid/content/Context;Lnet/openid/appauth/AppAuthConfiguration;Lnet/openid/appauth/browser/BrowserDescriptor;Lnet/openid/appauth/browser/CustomTabManager;)V
    ...
    .line 116
    iget-object p0, p3, Lnet/openid/appauth/browser/BrowserDescriptor;->useCustomTab:Ljava/lang/Boolean;
    ...
    .line 117
    iget-object p0, p3, Lnet/openid/appauth/browser/BrowserDescriptor;->packageName:Ljava/lang/String;

    invoke-virtual {p4, p0}, Lnet/openid/appauth/browser/CustomTabManager;->bind(Ljava/lang/String;)V
...
.method private checkNotDisposed()V
    ...
    .line 544
    iget-boolean p0, p0, Lnet/openid/appauth/AuthorizationService;->mDisposed:Z
...
.method private performAuthManagementRequest(Lnet/openid/appauth/AuthorizationManagementRequest;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Landroidx/browser/customtabs/CustomTabsIntent;)V
    ...
    .line 351
    :cond_0
    iget-object p0, p0, Lnet/openid/appauth/AuthorizationService;->mContext:Landroid/content/Context;
...
.method private prepareAuthorizationRequestIntent(Lnet/openid/appauth/AuthorizationManagementRequest;Landroidx/browser/customtabs/CustomTabsIntent;)Landroid/content/Intent;
    ...
    iget-object p0, p0, Lnet/openid/appauth/AuthorizationService;->mBrowser:Lnet/openid/appauth/browser/BrowserDescriptor;

    iget-object p0, p0, Lnet/openid/appauth/browser/BrowserDescriptor;->useCustomTab:Ljava/lang/Boolean;
    ...
    invoke-static {p1, p0}, Lnet/openid/appauth/internal/Logger;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public varargs createCustomTabsIntentBuilder([Landroid/net/Uri;)Landroidx/browser/customtabs/CustomTabsIntent$Builder;
    ...
    .line 139
    iget-object p0, p0, Lnet/openid/appauth/AuthorizationService;->mCustomTabManager:Lnet/openid/appauth/browser/CustomTabManager;

    invoke-virtual {p0, p1}, Lnet/openid/appauth/browser/CustomTabManager;->createTabBuilder([Landroid/net/Uri;)Landroidx/browser/customtabs/CustomTabsIntent$Builder;
...
.method public getAuthorizationRequestIntent(Lnet/openid/appauth/AuthorizationRequest;Landroidx/browser/customtabs/CustomTabsIntent;)Landroid/content/Intent;
    ...
    invoke-static {p0, p1, p2}, Lnet/openid/appauth/AuthorizationManagementActivity;->createStartForResultIntent(Landroid/content/Context;Lnet/openid/appauth/AuthorizationManagementRequest;Landroid/content/Intent;)Landroid/content/Intent;
...
.method public performRegistrationRequest(Lnet/openid/appauth/RegistrationRequest;Lnet/openid/appauth/AuthorizationService$RegistrationResponseCallback;)V
    ...
    iget-object p0, p0, Lnet/openid/appauth/AuthorizationService;->mClientConfiguration:Lnet/openid/appauth/AppAuthConfiguration;

    .line 525
    invoke-virtual {p0}, Lnet/openid/appauth/AppAuthConfiguration;->getConnectionBuilder()Lnet/openid/appauth/connectivity/ConnectionBuilder;

    move-result-object p0

    invoke-direct {v0, p1, p0, p2}, Lnet/openid/appauth/AuthorizationService$RegistrationRequestTask;-><init>(Lnet/openid/appauth/RegistrationRequest;Lnet/openid/appauth/connectivity/ConnectionBuilder;Lnet/openid/appauth/AuthorizationService$RegistrationResponseCallback;)V
    ...
    .line 527
    invoke-virtual {v0, p0}, Lnet/openid/appauth/AuthorizationService$RegistrationRequestTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public performTokenRequest(Lnet/openid/appauth/TokenRequest;Lnet/openid/appauth/ClientAuthentication;Lnet/openid/appauth/AuthorizationService$TokenResponseCallback;)V
    ...
    .line 509
    invoke-virtual {p0}, Lnet/openid/appauth/AppAuthConfiguration;->getSkipIssuerHttpsCheck()Z
    ...
    .line 510
    invoke-virtual {v0, p0}, Lnet/openid/appauth/AuthorizationService$TokenRequestTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
