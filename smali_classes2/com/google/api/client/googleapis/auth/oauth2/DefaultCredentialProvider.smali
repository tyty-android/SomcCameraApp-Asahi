...
.method private final getAppEngineCredential(Lcom/google/api/client/http/HttpTransport;Lcom/google/api/client/json/JsonFactory;)Lcom/google/api/client/googleapis/auth/oauth2/GoogleCredential;
    ...
    const-class v2, Lcom/google/api/client/json/JsonFactory;
    ...
    const-string p2, "Application Default Credentials failed to create the Google App Engine service account credentials class %s. Check that the component \'google-api-client-appengine\' is deployed."
...
.method private useGAEStandardAPI()Z
    ...
    .line 296
    const-string v2, "Unexpcted error trying to determine if runnning on Google App Engine: %s"
...
.method final getDefaultCredential(Lcom/google/api/client/http/HttpTransport;Lcom/google/api/client/json/JsonFactory;)Lcom/google/api/client/googleapis/auth/oauth2/GoogleCredential;
    ...
    const-string p2, "GOOGLE_APPLICATION_CREDENTIALS"

    const-string v0, "https://developers.google.com/accounts/docs/application-default-credentials"
