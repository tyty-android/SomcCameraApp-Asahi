...
.method public static final convertToControlRatio(Ljp/co/sony/mc/camera/device/CameraInfo$CameraId;FLjp/co/sony/mc/camera/configuration/parameters/VideoMfHdr;Ljp/co/sony/mc/camera/configuration/parameters/CapturingMode;Z)F
    .locals 6
    ...
    invoke-virtual/range {v0 .. v5}, Ljp/co/sony/mc/camera/configuration/parameters/ZoomRatio$Companion;->convertToControlRatio(Ljp/co/sony/mc/camera/device/CameraInfo$CameraId;FLjp/co/sony/mc/camera/configuration/parameters/VideoMfHdr;Ljp/co/sony/mc/camera/configuration/parameters/CapturingMode;Z)F
...
.method public static final convertToDisplayRatio(Ljp/co/sony/mc/camera/device/CameraInfo$CameraId;FLjp/co/sony/mc/camera/configuration/parameters/VideoMfHdr;Ljp/co/sony/mc/camera/configuration/parameters/CapturingMode;Z)F
    .locals 6
    .annotation runtime Lkotlin/jvm/JvmStatic;
    .end annotation
    ...
    invoke-virtual/range {v0 .. v5}, Ljp/co/sony/mc/camera/configuration/parameters/ZoomRatio$Companion;->convertToDisplayRatio(Ljp/co/sony/mc/camera/device/CameraInfo$CameraId;FLjp/co/sony/mc/camera/configuration/parameters/VideoMfHdr;Ljp/co/sony/mc/camera/configuration/parameters/CapturingMode;Z)F
...
.method public static final getBaseZoomRatio(Ljp/co/sony/mc/camera/device/CameraInfo$CameraId;ILjp/co/sony/mc/camera/configuration/parameters/VideoMfHdr;ZZ)F
    .locals 6
    .annotation runtime Lkotlin/jvm/JvmStatic;
    .end annotation
    ...
    invoke-virtual/range {v0 .. v5}, Ljp/co/sony/mc/camera/configuration/parameters/ZoomRatio$Companion;->getBaseZoomRatio(Ljp/co/sony/mc/camera/device/CameraInfo$CameraId;ILjp/co/sony/mc/camera/configuration/parameters/VideoMfHdr;ZZ)F
...
.method public static final getMinZoomRatio(Ljp/co/sony/mc/camera/device/CameraInfo$CameraId;ZLjp/co/sony/mc/camera/configuration/parameters/VideoMfHdr;Z)F
    .locals 1
    .annotation runtime Lkotlin/jvm/JvmStatic;
    .end annotation
    ...
    invoke-virtual {v0, p0, p1, p2, p3}, Ljp/co/sony/mc/camera/configuration/parameters/ZoomRatio$Companion;->getMinZoomRatio(Ljp/co/sony/mc/camera/device/CameraInfo$CameraId;ZLjp/co/sony/mc/camera/configuration/parameters/VideoMfHdr;Z)F
...
.method public static final isInOpticalZoomRange(Ljp/co/sony/mc/camera/device/CameraInfo$CameraId;ILjp/co/sony/mc/camera/configuration/parameters/VideoMfHdr;ZZ)Z
    .locals 6
    .annotation runtime Lkotlin/jvm/JvmStatic;
    .end annotation
