...
.method private static checkStorageWritable(Ljava/lang/String;)Z
    ...
    const-string v1, "Failed delete() not allowed"
...
.method public static deleteVideoFile(Ljp/co/sony/mc/camera/storage/Storage$StorageType;Ljava/lang/String;)V
    ...
    filled-new-array {v6, v3, v7, p1}, [Ljava/lang/Object;

    move-result-object p1

    .line 364
    const-string v3, "%s like \'%s\' AND %s like \'%s\'"
    ...
    .line 363
    invoke-virtual {v4, p0, p1, v3}, Landroid/content/ContentResolver;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string p1, "outputFile delete success"
...
.method public static updateBurstCaptureName(Ljava/lang/String;)Z
    ...
    filled-new-array {v8, v4, v9, p0}, [Ljava/lang/Object;

    move-result-object v10

    const-string v11, "%s like \'%s\' AND %s like \'%s\'"
    ...
    iput-object v7, v2, Ljp/co/sony/mc/camera/mediasaving/updator/CrQueryParameter;->where:Ljava/lang/String;
    ...
    .line 317
    invoke-static {v7, v10, v2}, Ljp/co/sony/mc/camera/view/contentsview/PhotoStackQueryHelper;->crQuery(Landroid/content/ContentResolver;Landroid/net/Uri;Ljp/co/sony/mc/camera/mediasaving/updator/CrQueryParameter;)Landroid/database/Cursor;
    ...
    .line 332
    invoke-virtual {v0, v9, p0}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const/4 p0, 0x0

    .line 333
    invoke-virtual {v7, v1, v0, p0, p0}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
