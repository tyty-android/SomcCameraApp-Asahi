...
# direct methods
.method public static synthetic $r8$lambda$DVWIo3LVwi3gXHNyu834Xg1E4qs(Landroid/widget/ImageButton;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0}, Ljp/co/sony/mc/camera/view/viewbinder/ProModeWbViewBinder$setupWbTemperatureSettingsMenu$1;->onValueChanged$lambda$0(Landroid/widget/ImageButton;)Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$VMQEhpvTr0HACuSkOucY2hB0RyE(Landroid/widget/ImageButton;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0}, Ljp/co/sony/mc/camera/view/viewbinder/ProModeWbViewBinder$setupWbTemperatureSettingsMenu$1;->onValueChanged$lambda$1(Landroid/widget/ImageButton;)Lkotlin/Unit;
...
.method private static final onValueChanged$lambda$0(Landroid/widget/ImageButton;)Lkotlin/Unit;
    .locals 1
...
.method private static final onValueChanged$lambda$1(Landroid/widget/ImageButton;)Lkotlin/Unit;
    .locals 1
...
.method public onValueChanged(Ljp/co/sony/mc/camera/view/widget/DialPicker;II)V
    ...
    new-instance v3, Ljp/co/sony/mc/camera/idd/value/IddTemperature;

    iget-object v4, p0, Ljp/co/sony/mc/camera/view/viewbinder/ProModeWbViewBinder$setupWbTemperatureSettingsMenu$1;->$options:[Ljava/lang/Float;
    ...
    invoke-direct {v3, v4}, Ljp/co/sony/mc/camera/idd/value/IddTemperature;-><init>(I)V

    check-cast v3, Ljp/co/sony/mc/camera/idd/value/IddSettingValue;

    invoke-virtual {p2, v2, v3}, Ljp/co/sony/mc/camera/idd/event/IddSettingEvent;->setting(Ljp/co/sony/mc/camera/idd/value/IddSettingKey;Ljp/co/sony/mc/camera/idd/value/IddSettingValue;)Ljp/co/sony/mc/camera/idd/event/IddSettingEvent;
    ...
    iget-object v2, p0, Ljp/co/sony/mc/camera/view/viewbinder/ProModeWbViewBinder$setupWbTemperatureSettingsMenu$1;->$arrowRightButton:Landroid/widget/ImageButton;

    new-instance v3, Ljp/co/sony/mc/camera/view/viewbinder/ProModeWbViewBinder$setupWbTemperatureSettingsMenu$1$$ExternalSyntheticLambda0;

    invoke-direct {v3, v2}, Ljp/co/sony/mc/camera/view/viewbinder/ProModeWbViewBinder$setupWbTemperatureSettingsMenu$1$$ExternalSyntheticLambda0;-><init>(Landroid/widget/ImageButton;)V

    invoke-virtual {p1, p2, v3}, Ljp/co/sony/mc/camera/util/AccessibilityUtil;->watchFocused(Landroid/view/View;Lkotlin/jvm/functions/Function0;)V
    ...
    iget-object v3, p0, Ljp/co/sony/mc/camera/view/viewbinder/ProModeWbViewBinder$setupWbTemperatureSettingsMenu$1;->$arrowLeftButton:Landroid/widget/ImageButton;

    new-instance v4, Ljp/co/sony/mc/camera/view/viewbinder/ProModeWbViewBinder$setupWbTemperatureSettingsMenu$1$$ExternalSyntheticLambda1;

    invoke-direct {v4, v3}, Ljp/co/sony/mc/camera/view/viewbinder/ProModeWbViewBinder$setupWbTemperatureSettingsMenu$1$$ExternalSyntheticLambda1;-><init>(Landroid/widget/ImageButton;)V

    invoke-virtual {p1, v2, v4}, Ljp/co/sony/mc/camera/util/AccessibilityUtil;->watchFocused(Landroid/view/View;Lkotlin/jvm/functions/Function0;)V
