...
# direct methods
.method public static synthetic $r8$lambda$2fk9n7ZTlChr5OlOqHAwdQIIgFQ(Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder;Z)V
    .locals 0

    invoke-static {p0, p1}, Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder;->touchExplorationStateChangeListener$lambda$0(Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder;Z)V
...
.method public constructor <init>(Ljp/co/sony/mc/camera/databinding/FragmentProModeCapturingModeInfoListBinding;)V
    ...
    .line 36
    new-instance p1, Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder$$ExternalSyntheticLambda0;

    invoke-direct {p1, p0}, Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder$$ExternalSyntheticLambda0;-><init>(Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder;)V
...
.method private static final touchExplorationStateChangeListener$lambda$0(Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder;Z)V
    .locals 2
    ...
    new-instance v1, Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder$touchExplorationStateChangeListener$1$1;

    invoke-direct {v1, p0}, Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder$touchExplorationStateChangeListener$1$1;-><init>(Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder;)V
...
.method public onCreate(Landroidx/lifecycle/LifecycleOwner;)V
    ...
    .line 57
    sget-object v2, Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder$onCreate$1$capturingModeInfoMenuAdapter$1;->INSTANCE:Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder$onCreate$1$capturingModeInfoMenuAdapter$1;
    ...
    .line 64
    new-instance v1, Ljp/co/sony/mc/camera/view/widget/CapturingModeMenuAdapter$CapturingModeItem;
    ...
    invoke-direct {v1, v2, v3}, Ljp/co/sony/mc/camera/view/widget/CapturingModeMenuAdapter$CapturingModeItem;-><init>(Ljp/co/sony/mc/camera/configuration/parameters/CapturingMode;Z)V
    ...
    invoke-direct {v2, v4, v3}, Ljp/co/sony/mc/camera/view/widget/CapturingModeMenuAdapter$CapturingModeItem;-><init>(Ljp/co/sony/mc/camera/configuration/parameters/CapturingMode;Z)V

    .line 66
    new-instance v4, Ljp/co/sony/mc/camera/view/widget/CapturingModeMenuAdapter$CapturingModeItem;

    sget-object v5, Ljp/co/sony/mc/camera/configuration/parameters/CapturingMode;->PHOTO_PRO_M:Ljp/co/sony/mc/camera/configuration/parameters/CapturingMode;

    invoke-direct {v4, v5, v3}, Ljp/co/sony/mc/camera/view/widget/CapturingModeMenuAdapter$CapturingModeItem;-><init>(Ljp/co/sony/mc/camera/configuration/parameters/CapturingMode;Z)V

    filled-new-array {v1, v2, v4}, [Ljp/co/sony/mc/camera/view/widget/CapturingModeMenuAdapter$CapturingModeItem;
    ...
    new-instance v1, Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder$onCreate$2;

    invoke-direct {v1, p0}, Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder$onCreate$2;-><init>(Ljp/co/sony/mc/camera/view/viewbinder/ProModeCapturingModeMenuInfoViewBinder;)V
