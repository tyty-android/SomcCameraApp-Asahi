.class public Ljp/co/sony/mc/camera/util/capability/IntegerRangeCapabilityItem;
...
.method bridge synthetic getDefaultValue()Ljava/lang/Object;
    ...
    .line 20
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/IntegerRangeCapabilityItem;->getDefaultValue()Landroid/util/Range;
...
.method public read(Landroid/content/SharedPreferences;Ljava/lang/String;)Landroid/util/Range;
    ...
    .line 34
    invoke-static {p0}, Ljp/co/sony/mc/camera/util/capability/SharedPrefsTranslator;->getIntegerRange(Ljava/lang/String;)Landroid/util/Range;
...
.method public bridge synthetic read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 20
    invoke-virtual {p0, p1, p2}, Ljp/co/sony/mc/camera/util/capability/IntegerRangeCapabilityItem;->read(Landroid/content/SharedPreferences;Ljava/lang/String;)Landroid/util/Range;
...
.method public write(Landroid/content/SharedPreferences$Editor;)V
    ...
    .line 41
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/IntegerRangeCapabilityItem;->get()Ljava/lang/Object;
    ...
    .line 43
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/IntegerRangeCapabilityItem;->getName()Ljava/lang/String;

    move-result-object p0

    invoke-static {v0}, Ljp/co/sony/mc/camera/util/capability/SharedPrefsTranslator;->fromIntegerRange(Landroid/util/Range;)Ljava/lang/String;
