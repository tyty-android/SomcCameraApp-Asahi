.class public Ljp/co/sony/mc/camera/util/capability/AutoFramingVideoConfigurationListCapabilityItem;
.super Ljp/co/sony/mc/camera/util/capability/CapabilityItem;
.source "AutoFramingVideoConfigurationListCapabilityItem.java"
...
.method bridge synthetic getDefaultValue()Ljava/lang/Object;
    ...
    .line 17
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/AutoFramingVideoConfigurationListCapabilityItem;->getDefaultValue()Ljava/util/List;
...
.method public bridge synthetic read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 17
    invoke-virtual {p0, p1, p2}, Ljp/co/sony/mc/camera/util/capability/AutoFramingVideoConfigurationListCapabilityItem;->read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/util/List;
...
.method public read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 33
    invoke-static {p0}, Ljp/co/sony/mc/camera/util/capability/SharedPrefsTranslator;->getAutoFramingVideoConfigurationList(Ljava/lang/String;)Ljava/util/List;
...
.method public write(Landroid/content/SharedPreferences$Editor;)V
    ...
    .line 40
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/AutoFramingVideoConfigurationListCapabilityItem;->get()Ljava/lang/Object;
    ...
    .line 42
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/AutoFramingVideoConfigurationListCapabilityItem;->getName()Ljava/lang/String;

    move-result-object p0

    .line 43
    invoke-static {v0}, Ljp/co/sony/mc/camera/util/capability/SharedPrefsTranslator;->fromAutoFramingVideoConfigurationList(Ljava/util/List;)Ljava/lang/String;
