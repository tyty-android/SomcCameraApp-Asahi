.class public Ljp/co/sony/mc/camera/util/capability/IntArrayListCapabilityItem;
...
.method bridge synthetic getDefaultValue()Ljava/lang/Object;
    ...
    .line 22
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/IntArrayListCapabilityItem;->getDefaultValue()Ljava/util/List;
...
.method public bridge synthetic read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 22
    invoke-virtual {p0, p1, p2}, Ljp/co/sony/mc/camera/util/capability/IntArrayListCapabilityItem;->read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/util/List;
...
.method public read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 36
    invoke-static {p0}, Ljp/co/sony/mc/camera/util/capability/SharedPrefsTranslator;->getIntArrayList(Ljava/lang/String;)Ljava/util/List;
...
.method public write(Landroid/content/SharedPreferences$Editor;)V
    ...
    .line 43
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/IntArrayListCapabilityItem;->get()Ljava/lang/Object;
    ...
    .line 45
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/IntArrayListCapabilityItem;->getName()Ljava/lang/String;

    move-result-object p0

    invoke-static {v0}, Ljp/co/sony/mc/camera/util/capability/SharedPrefsTranslator;->fromIntArrayList(Ljava/util/List;)Ljava/lang/String;
