.class public Ljp/co/sony/mc/camera/util/capability/VideoSnapshotSizeListCapabilityItem;
.super Ljp/co/sony/mc/camera/util/capability/CapabilityItem;
.source "VideoSnapshotSizeListCapabilityItem.java"
...
.method bridge synthetic getDefaultValue()Ljava/lang/Object;
    ...
    .line 15
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/VideoSnapshotSizeListCapabilityItem;->getDefaultValue()Ljava/util/List;
...
.method public bridge synthetic read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 15
    invoke-virtual {p0, p1, p2}, Ljp/co/sony/mc/camera/util/capability/VideoSnapshotSizeListCapabilityItem;->read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/util/List;
...
.method public read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 30
    invoke-static {p0}, Ljp/co/sony/mc/camera/util/capability/SharedPrefsTranslator;->getVideoSnapshotSizeList(Ljava/lang/String;)Ljava/util/List;
...
.method public write(Landroid/content/SharedPreferences$Editor;)V
    ...
    .line 37
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/VideoSnapshotSizeListCapabilityItem;->get()Ljava/lang/Object;
    ...
    .line 39
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/VideoSnapshotSizeListCapabilityItem;->getName()Ljava/lang/String;

    move-result-object p0

    invoke-static {v0}, Ljp/co/sony/mc/camera/util/capability/SharedPrefsTranslator;->fromVideoSnapshotSizeList(Ljava/util/List;)Ljava/lang/String;
