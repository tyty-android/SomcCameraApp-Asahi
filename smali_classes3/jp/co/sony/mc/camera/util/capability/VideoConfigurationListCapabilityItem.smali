.class public Ljp/co/sony/mc/camera/util/capability/VideoConfigurationListCapabilityItem;
...
.method bridge synthetic getDefaultValue()Ljava/lang/Object;
    ...
    .line 20
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/VideoConfigurationListCapabilityItem;->getDefaultValue()Ljava/util/List;
...
.method public bridge synthetic read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 20
    invoke-virtual {p0, p1, p2}, Ljp/co/sony/mc/camera/util/capability/VideoConfigurationListCapabilityItem;->read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/util/List;
...
.method public read(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 35
    invoke-static {p0}, Ljp/co/sony/mc/camera/util/capability/SharedPrefsTranslator;->getVideoConfigurationList(Ljava/lang/String;)Ljava/util/List;
...
.method public write(Landroid/content/SharedPreferences$Editor;)V
    ...
    .line 42
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/VideoConfigurationListCapabilityItem;->get()Ljava/lang/Object;
    ...
    .line 44
    invoke-virtual {p0}, Ljp/co/sony/mc/camera/util/capability/VideoConfigurationListCapabilityItem;->getName()Ljava/lang/String;

    move-result-object p0

    invoke-static {v0}, Ljp/co/sony/mc/camera/util/capability/SharedPrefsTranslator;->fromVideoConfigurationList(Ljava/util/List;)Ljava/lang/String;
