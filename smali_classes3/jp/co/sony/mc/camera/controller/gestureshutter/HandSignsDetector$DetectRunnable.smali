...
.method public run()V
    ...
    iget v3, p0, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector$DetectRunnable;->width:I

    iget v4, p0, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector$DetectRunnable;->height:I

    invoke-virtual {v2, v3, v4}, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector$DetectContext;->initialize(II)V
    ...
    .line 405
    :try_start_0
    iget-object v3, p0, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector$DetectRunnable;->this$0:Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector;

    invoke-static {v3}, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector;->-$$Nest$fgetmYuvBytes(Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector;)[B
    ...
    .line 409
    invoke-static {v1, v3, v4, v7, v8}, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsNativeWrapper;->shrinkYvu420Sp([BII[BLjp/co/sony/mc/camera/controller/gestureshutter/HandSignsNativeWrapper$ShrinkRatio;)V
    ...
    invoke-static {v3}, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector;->-$$Nest$fgetmNativeWrapper(Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector;)Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsNativeWrapper;

    move-result-object v9

    iget-object v3, p0, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector$DetectRunnable;->this$0:Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector;

    invoke-static {v3}, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector;->-$$Nest$fgetmDetectContext(Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector;)Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector$DetectContext;

    move-result-object v3

    invoke-virtual {v3}, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector$DetectContext;->getDetectWidth()I
    ...
    .line 414
    invoke-virtual {v3}, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector$DetectContext;->getDetectHeight()I
    ...
    invoke-virtual {v3}, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector$DetectContext;->getFrame()[B

    move-result-object v12

    iget-object v3, p0, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector$DetectRunnable;->this$0:Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector;

    invoke-static {v3}, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector;->-$$Nest$fgetmRoll(Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector;)I
    ...
    iget-object v3, p0, Ljp/co/sony/mc/camera/controller/gestureshutter/HandSignsDetector$DetectRunnable;->mYuvBuffer:Ljava/nio/ByteBuffer;
