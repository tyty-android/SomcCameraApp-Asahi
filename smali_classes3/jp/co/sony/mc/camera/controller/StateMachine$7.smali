...
.method static constructor <clinit>()V
    ...
    sget-object v6, Ljp/co/sony/mc/camera/controller/StateMachine$CaptureState;->STATE_VIDEO_STORE:Ljp/co/sony/mc/camera/controller/StateMachine$CaptureState;
    ...
    :try_start_5
    sget-object v6, Ljp/co/sony/mc/camera/controller/StateMachine$7;->$SwitchMap$jp$co$sony$mc$camera$controller$StateMachine$CaptureState:[I

    sget-object v7, Ljp/co/sony/mc/camera/controller/StateMachine$CaptureState;->STATE_WARNING:Ljp/co/sony/mc/camera/controller/StateMachine$CaptureState;

    invoke-virtual {v7}, Ljp/co/sony/mc/camera/controller/StateMachine$CaptureState;->ordinal()I
    ...
    sput-object v6, Ljp/co/sony/mc/camera/controller/StateMachine$7;->$SwitchMap$jp$co$sony$mc$camera$storage$Storage$StorageType:[I

    :try_start_6
    sget-object v7, Ljp/co/sony/mc/camera/storage/Storage$StorageType;->INTERNAL:Ljp/co/sony/mc/camera/storage/Storage$StorageType;

    invoke-virtual {v7}, Ljp/co/sony/mc/camera/storage/Storage$StorageType;->ordinal()I
    ...
    :catch_6
    :try_start_7
    sget-object v6, Ljp/co/sony/mc/camera/controller/StateMachine$7;->$SwitchMap$jp$co$sony$mc$camera$storage$Storage$StorageType:[I
    ...
    sput-object v6, Ljp/co/sony/mc/camera/controller/StateMachine$7;->$SwitchMap$jp$co$sony$mc$camera$storage$SavingTaskManager$SavedFileType:[I

    :try_start_8
    sget-object v7, Ljp/co/sony/mc/camera/storage/SavingTaskManager$SavedFileType;->BURST:Ljp/co/sony/mc/camera/storage/SavingTaskManager$SavedFileType;

    invoke-virtual {v7}, Ljp/co/sony/mc/camera/storage/SavingTaskManager$SavedFileType;->ordinal()I
    ...
    :catch_8
    :try_start_9
    sget-object v6, Ljp/co/sony/mc/camera/controller/StateMachine$7;->$SwitchMap$jp$co$sony$mc$camera$storage$SavingTaskManager$SavedFileType:[I

    sget-object v7, Ljp/co/sony/mc/camera/storage/SavingTaskManager$SavedFileType;->VIDEO:Ljp/co/sony/mc/camera/storage/SavingTaskManager$SavedFileType;
    ...
    sget-object v7, Ljp/co/sony/mc/camera/storage/SavingTaskManager$SavedFileType;->PHOTO:Ljp/co/sony/mc/camera/storage/SavingTaskManager$SavedFileType;
    ...
    sget-object v7, Ljp/co/sony/mc/camera/storage/SavingTaskManager$SavedFileType;->PHOTO_DURING_REC:Ljp/co/sony/mc/camera/storage/SavingTaskManager$SavedFileType;
    ...
    sput-object v6, Ljp/co/sony/mc/camera/controller/StateMachine$7;->$SwitchMap$jp$co$sony$mc$camera$controller$StateMachine$StaticEvent:[I

    :try_start_c
    sget-object v7, Ljp/co/sony/mc/camera/controller/StateMachine$StaticEvent;->EVENT_ON_PHOTO_STACK_INITIALIZED:Ljp/co/sony/mc/camera/controller/StateMachine$StaticEvent;
    ...
    sget-object v7, Ljp/co/sony/mc/camera/controller/StateMachine$StaticEvent;->EVENT_ON_HEAD_UP_DISPLAY_INITIALIZED:Ljp/co/sony/mc/camera/controller/StateMachine$StaticEvent;
    ...
    sget-object v7, Ljp/co/sony/mc/camera/controller/StateMachine$StaticEvent;->EVENT_ON_AUTO_FLASH_CHANGED:Ljp/co/sony/mc/camera/controller/StateMachine$StaticEvent;
    ...
    sget-object v7, Ljp/co/sony/mc/camera/controller/StateMachine$StaticEvent;->EVENT_ON_AUTO_HDR_CHANGED:Ljp/co/sony/mc/camera/controller/StateMachine$StaticEvent;
    ...
    sget-object v7, Ljp/co/sony/mc/camera/controller/StateMachine$StaticEvent;->EVENT_ON_FACE_DETECTED:Ljp/co/sony/mc/camera/controller/StateMachine$StaticEvent;
