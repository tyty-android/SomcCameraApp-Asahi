.class Ljp/co/sony/mc/camera/database/aisuggestion/dao/DefaultAiSuggestionParameterDao_Impl$3;
...
.method constructor <init>(Ljp/co/sony/mc/camera/database/aisuggestion/dao/DefaultAiSuggestionParameterDao_Impl;)V
    ...
    .line 77
    iput-object p1, p0, Ljp/co/sony/mc/camera/database/aisuggestion/dao/DefaultAiSuggestionParameterDao_Impl$3;->this$0:Ljp/co/sony/mc/camera/database/aisuggestion/dao/DefaultAiSuggestionParameterDao_Impl;
...
.method protected bridge synthetic bind(Landroidx/sqlite/SQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Ljp/co/sony/mc/camera/database/aisuggestion/dao/DefaultAiSuggestionParameterDao_Impl$3;->bind(Landroidx/sqlite/SQLiteStatement;Ljp/co/sony/mc/camera/database/aisuggestion/entity/DefaultAiSuggestionParameterEntity;)V
...
.method protected bind(Landroidx/sqlite/SQLiteStatement;Ljp/co/sony/mc/camera/database/aisuggestion/entity/DefaultAiSuggestionParameterEntity;)V
    ...
    .line 88
    invoke-virtual {p2}, Ljp/co/sony/mc/camera/database/aisuggestion/entity/DefaultAiSuggestionParameterEntity;->getBokehStrength()I
    ...
    .line 89
    invoke-virtual {p2}, Ljp/co/sony/mc/camera/database/aisuggestion/entity/DefaultAiSuggestionParameterEntity;->getBaseAiSuggestionParameter()Ljp/co/sony/mc/camera/database/aisuggestion/entity/BaseAiSuggestionParameter;
...
.method protected createQuery()Ljava/lang/String;
    ...
    .line 81
    const-string p0, "UPDATE OR ABORT `default_ai_suggestion_parameter` SET `suggestionParameterIndex` = ?,`bokehStrength` = ?,`aeExposureCompensation` = ?,`awbColorCompensationAb` = ?,`awbColorCompensationGm` = ?,`colorToneProfile` = ?,`saturationScaleFactor` = ?,`contrastScaleFactor` = ? WHERE `suggestionParameterIndex` = ?"
