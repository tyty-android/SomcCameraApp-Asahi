...
.method public build()Lio/grpc/InternalChannelz$ChannelStats;
    ...
    .line 472
    new-instance v15, Lio/grpc/InternalChannelz$ChannelStats;

    iget-object v1, v0, Lio/grpc/InternalChannelz$ChannelStats$Builder;->target:Ljava/lang/String;

    iget-object v2, v0, Lio/grpc/InternalChannelz$ChannelStats$Builder;->state:Lio/grpc/ConnectivityState;

    iget-object v3, v0, Lio/grpc/InternalChannelz$ChannelStats$Builder;->channelTrace:Lio/grpc/InternalChannelz$ChannelTrace;

    iget-wide v4, v0, Lio/grpc/InternalChannelz$ChannelStats$Builder;->callsStarted:J

    iget-wide v6, v0, Lio/grpc/InternalChannelz$ChannelStats$Builder;->callsSucceeded:J

    iget-wide v8, v0, Lio/grpc/InternalChannelz$ChannelStats$Builder;->callsFailed:J

    iget-wide v10, v0, Lio/grpc/InternalChannelz$ChannelStats$Builder;->lastCallStartedNanos:J

    iget-object v12, v0, Lio/grpc/InternalChannelz$ChannelStats$Builder;->subchannels:Ljava/util/List;

    iget-object v13, v0, Lio/grpc/InternalChannelz$ChannelStats$Builder;->sockets:Ljava/util/List;
